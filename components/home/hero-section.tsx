...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-foreground text-background">
      ...
      <div className="relative mx-auto max-w-5xl px-6 pt-24 pb-32 sm:pt-32 sm:pb-36 lg:px-8 lg:pt-40 lg:pb-40 text-center">
      ...
      {/* Wave transition to white section below */}
